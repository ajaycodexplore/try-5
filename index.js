...
app.get("/second", (req, res) => {
  const filePath2 = path.join(__dirname, "public", "tcp_header_fields.rtf");
  fs.readFile(filePath2, "utf8", (err, data) => { //const filePath = path.join(__dirname, "public", "tcp_conn_mgmt.rtf");
    if (err) {
      res.send(err);
      return;
    }
